...
-- update entry from reception
UPDATE DoctorQueue
SET appointment_id = 3, patient_id = 3
WHERE doctor_id = 1;

-- check for new entry
select patient_id, appointment_id from DoctorQueue where doctor_id = 1;
...
VALUES ('1','10:30:00', '13:00:00','sunday','02:30:00'),
       ('4','10:30:00', '13:00:00','monday','02:30:00'),
	   ('4','14:00:00', '18:00:00','monday','04:00:00'),
	   ('5','10:30:00', '13:00:00','tuesday','02:30:00'),
	   ('5','14:00:00', '18:00:00','thursday','04:00:00'),
	   ('1','15:00:00', '18:00:00','thursday','04:00:00')
